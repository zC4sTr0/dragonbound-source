(function(a) {
    function b(b, d) {
        ...
        var o, h = this,
            ...
            M = !1,
            N = !1,
            J, C, Y, fa, Da, na, oa, pa, Ea, La, ua, va, sa, Q, wa, Fa, Z, ta, D, V, za, Aa, R, w = null,
            Ga = null,
            ...
            u = null,
            ka, O = null,
            Ma, ya, la, H, z, Na, T, I, Ia = Array.prototype.slice,
            L = !1,
            ...
            Ka = !x.match(/usehtml5audio/i) && !x.match(/sm2\-ignorebadua/i) && B && !r.match(/silk/i) && r.match(/OS X 10_6_([3-7])/i),
        ...
        this.reboot = function() {
            ...
            if (n) try {
                ea && (Ga = n.innerHTML), w = n.parentNode.removeChild(n)
            } catch (d) {}
            Ga = w = O = null;
        ...
        o = function(a) {
            ...
            this.unload = function() {
                if (0 !== c.readyState) {
                    if (c.isHTML5) {
                        if (B(), c._a) c._a.pause(), z(c._a, "about:blank"), c.url = "about:blank"
            ...
            this.destruct = function(a) {
                if (c.isHTML5) {
                    if (B(), c._a) c._a.pause(), z(c._a), L || j(), c._a._t = null, c._a = null
            ...
            this.start = this.play = function(a, b) {
                ...
                1 === c.playState && !c.paused && ((d = c._iO.multiShot) || (f = c));
                if (null !== f) return f;
                c.loaded || (0 === c.readyState ? (c.isHTML5 || (c._iO.autoPlay = !0), c.load(c._iO)) : 2 === c.readyState && (f = c));
                if (null !== f) return f;
                ...
                if (c.paused && c.position && 0 < c.position) c.resume();
                    ...
                    c.isHTML5 ? (m(), f = c._setup_html5(), c.setPosition(c._iO.position), f.play()) : (f = n._start(c.id, c._iO.loops || 1, 9 === t ? c._iO.position : c._iO.position / 1E3, c._iO.multiShot), 9 === t && !f && c._iO.onplayerror && c._iO.onplayerror.apply(c))
                }
                return c
            };
            this.stop = function(a) {
            ...
            this.clearOnPosition = function(a, c) {
                ...
                if (isNaN(a)) return !1;
                for (b = 0; b < o.length; b++) if (a === o[b].position && (!c || c === o[b].method)) o[b].fired && r--, o.splice(b, 1)
            };
            ...
            this._resetOnPosition = function(a) {
                ...
                c = o.length;
                if (!c) return !1;
                for (c -= 1; 0 <= c; c--) if (b = o[c], b.fired && a <= b.position) b.fired = !1, r--;
                return !0
            };
            p = function() {
                var a = c._iO,
                    ...
                    f, e;
                e = function() {
                    c.clearOnPosition(d, e);
                    c.stop()
                };
                f = function() {
                    if (null !== d && !isNaN(d)) c.onPosition(d, e)
                };
                null !== b && !isNaN(b) && (a.position = b, a.multiShot = !1, f());
                return a
            };
            k = function() {
            ...
            this._onTimer = function(a) {
                var f, e = !1,
                    j = {};
                if (c._hasTimer || a) {
                    if (c._a && (a || (0 < c.playState || 1 === c.readyState) && !c.paused)) f = c._get_html5_duration(), f !== b && (b = f, c.duration = f, e = !0), c.durationEstimate = c.duration, f = 1E3 * c._a.currentTime || 0, f !== d && (d = f, e = !0), (e || a) && c._whileplaying(f, j, j, j, j);
                    return e
                }
            };
            ...
            this._setup_html5 = function(a) {
                ...
                if (d) {
                    ...
                    f(B && B.url ? a.url === B.url : q ? q === a.url : !1);
                    d.src = a.url;
                    q = c.url = a.url;
                    d._called_load = !1
            ...
            this._whileloading = function(a, b, d, f) {
                var e = c._iO;
                c.bytesLoaded = a;
                c.bytesTotal = b;
                c.duration = Math.floor(d);
                c.bufferLength = f;
                if (e.isMovieStar) c.durationEstimate = c.duration;
                else if (c.durationEstimate = e.duration ? c.duration > e.duration ? c.duration : e.duration : parseInt(c.bytesTotal / c.bytesLoaded * c.duration, 10), "undefined" === typeof c.durationEstimate) c.durationEstimate = c.duration;
                c.isHTML5 || (c.buffered = [{
                    start: 0,
                    end: c.duration
                }]);
                (3 !== c.readyState || c.isHTML5) && e.whileloading && e.whileloading.apply(c)
            };
            this._whileplaying = function(a, b, d, f, e) {
                var j = c._iO;
                ...
                if (!c.isHTML5 && 8 < t && (j.usePeakData && ("undefined" !== typeof b && b) && (c.peakData = {
                    ...
                    left: d.split(","),
                    right: f.split(",")
                }), j.useEQData && "undefined" !== typeof e && e && e.leftEQ && (a = e.leftEQ.split(","), c.eqData = a, c.eqData.left = a, "undefined" !== typeof e.rightEQ && e.rightEQ))) c.eqData.right = e.rightEQ.split(",");
            ...
            this._onmetadata = function(a, b) {
                var d = {},
                    f, e;
                f = 0;
                for (e = a.length; f < e; f++) d[a[f]] = b[f];
                c.metadata = d;
        ...
        C = function(a, c) {
            ...
            for (f in d) d.hasOwnProperty(f) && "undefined" === typeof b[f] && (b[f] = "object" !== typeof d[f] || null === d[f] ? d[f] : C(b[f], d[f]));
            return b
        };
        fa = {
            onready: 1,
        ...
        Y = function(a, c) {
            var b, d = !0,
                ...
                e = h.setupOptions;
            for (b in a) if (a.hasOwnProperty(b)) if ("object" !== typeof a[b] || null === a[b] || a[b] instanceof Array) f && "undefined" !== typeof fa[c] ? h[c][b] = a[b] : "undefined" !== typeof e[b] ? (h.setupOptions[b] = a[b], h[b] = a[b]) : "undefined" === typeof fa[b] ? (ia(S("undefined" === typeof h[b] ? "setupUndef" : "setupError", b), 2), d = !1) : h[b] instanceof Function ? h[b].apply(h, a[b] instanceof Array ? a[b] : [a[b]]) : h[b] = a[b];
            else if ("undefined" === typeof fa[b]) ia(S("undefined" === typeof h[b] ? "setupUndef" : "setupError", b), 2), d = !1;
            else
            return Y(a[b], b);
            return d
        };
        ...
        ma = {
            ...
            progress: j(function(a) {
                ...
                if (f && f.length) {
                    b = 0;
                    for (d = f.length; b < d; b++) c.buffered.push({
                        start: f.start(b),
                        end: f.end(b)
                    });
                    f = f.end(0) - f.start(0);
                    b = f / a.target.duration
                }
                isNaN(b) || (c._onbufferchange(0), c._whileloading(b, e, c._get_html5_duration()), b && e && b === e && ma.canplaythrough.call(this, a))
            }),
        ...
        la = function(a) {
            ...
            if (!H) {
                H = [];
                for (d in b) b.hasOwnProperty(d) && (H.push(d), b[d].related && (H = H.concat(b[d].related)));
                H = RegExp("\\.(" + H.join("|") + ")(\\?.*)?$", "i")
            }
            d = c ? c.toLowerCase().match(H) : null;
        ...
        T = function() {
            function a(b) {
                ...
                if (b instanceof Array) {
                    d = 0;
                    for (f = b.length; d < f && !e; d++) if (h.html5[b[d]] || c.canPlayType(b[d]).match(h.html5Test)) e = !0, h.html5[b[d]] = !0, h.flash[b[d]] = !! b[d].match(Ua);
                    d = e
            ...
            var c = "undefined" !== typeof Audio ? W ? new Audio(null) : new Audio : null,
                b, d, f = {},
                e;
            e = h.audioFormats;
            for (b in e) if (e.hasOwnProperty(b) && (d = "audio/" + b, f[b] = a(e[b].type), f[d] = f[b], b.match(Ua) ? (h.flash[b] = !0, h.flash[d] = !0) : (h.flash[b] = !1, h.flash[d] = !1), e[b] && e[b].related)) for (d = e[b].related.length - 1; 0 <= d; d--) f["audio/" + e[b].related[d]] = f[b], h.html5[e[b].related[d]] = f[b], h.flash[e[b].related[d]] = f[b];
        ...
        za = function(a) {
            for (var c in a) a.hasOwnProperty(c) && "function" === typeof a[c] && (a[c] = y)
        };
        Aa = function(a) {
            "undefined" === typeof a && (a = !1);
            (M || a) && h.disable(a)
        ...
        V = function() {
            h.debugURLParam.test(x) && (h.debugMode = !0)
        };
        G = this.getSoundById;
        ga = function() {
            var a = [];
        ...
        na = function(a) {
            ...
            var c = {
                ...
                d = [],
                f, c = [c],
                e = O && h.useFlashBlock && !h.ok();
            a.error && (c[0].error = a.error);
            a = 0;
            for (f = b.length; a < f; a++)!0 !== b[a].fired && d.push(b[a]);
            if (d.length) {
                a = 0;
                for (f = d.length; a < f; a++) if (d[a].scope ? d[a].method.apply(d[a].scope, c) : d[a].method.apply(this, c), !e) d[a].fired = !0
            }
            return !0
        };
        oa = function() {
        ...
        Z = function(a, c) {
            ...
            h.debugFlash && (e.FlashVars = "debug=1");
            h.wmode || delete e.wmode;
            if (ea) d = s.createElement("div"), B = ['<object id="' + a + '" data="' + c + '" type="' + e.type + '" title="' + e.title + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="' + Va + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0">', b("movie", c), b("AllowScriptAccess", h.allowScriptAccess), b("quality", e.quality), h.wmode ? b("wmode", h.wmode) : "", b("bgcolor", h.bgColor), b("hasPriority", "true"), h.debugFlash ? b("FlashVars", e.FlashVars) : "", "</object>"].join("");
            else
            for (j in d = s.createElement("embed"), e) e.hasOwnProperty(j) && d.setAttribute(j, e[j]);
            V();
            m = ga();
            if (e = Fa()) if (h.oMC = p(h.movieID) || s.createElement("div"), h.oMC.id) k = h.oMC.className, h.oMC.className = (k ? k + " " : "movieContainer") + (m ? " " + m : ""), h.oMC.appendChild(d), ea && (j = h.oMC.appendChild(s.createElement("div")), j.className = "sm2-object-box", j.innerHTML = B), P = !0;
            else {
                h.oMC.id = h.movieID;
                ...
                try {
                    ea || h.oMC.appendChild(d), e.appendChild(h.oMC), ea && (j = h.oMC.appendChild(s.createElement("div")), j.className = "sm2-object-box", j.innerHTML = B), P = !0
                } catch (ra) {
        ...
        va = function() {
            ...
            if (n) return !1;
            n = h.getMovie(h.id);
            n || (w ? (ea ? h.oMC.innerHTML = Ga : h.oMC.appendChild(w), w = null, E = !0) : Z(h.id, h.url), n = h.getMovie(h.id));
        ...
        Ea = function() {
            ...
            I.remove(q, "load", pa);
            if (Pa && !Ra) return !1;
            F || (a = h.getMoviePercent(), 0 < a && 100 > a && (c = !0));
            setTimeout(function() {
                a = h.getMoviePercent();
        ...
        J = function(a) {
            ...
            var c = !0,
                b;
            if (!h.useFlashBlock || !h.flashLoadTimeout || h.getMoviePercent()) F = !0, M && (b = {
        ...
        A = function() {
            ...
            va();
            try {
                n._externalInterfaceTest(!1), D(!0, h.flashPollingInterval || (h.useHighPerformance ? 10 : 50)), h.debugMode || n._disableDebug(), h.enabled = !0, h.html5Only || I.add(q, "unload", y)
            } catch (a) {
                return ta({
                            ...
                            if (a.support.matrixFilter) d(c, e);
                                ...
                                if (q !== null) for (var P in q) {
                                    ...
                                    if (k === P) {
                                        if (k !== "matrix") {
                                            t = t + (k + "(");
                                            t = t + (A === "X" || A === "" ? e + m : E[0] !== "" ? E[0] : a.cssHooks[k + "X"].get(c) + m);
                                            t = t + (A === "Y" ? ", " + e + m : E[1] !== "" ? ", " + E[1] : k + "Y" in a.cssHooks ? ", " + a.cssHooks[k + "Y"].get(c) + m : "");
                                            t = t + ") "
                                        } else t = t + (e + " ");
                                        K = true
                                    } else {
                                ...
                                K || (t = t + (k + A + "(" + e + m + ") "));
                                c.style[a.cssProps.transform] = t
                            }
                        },
                        get: function(c) {
...
(function(a) {
    function b(b, c) {
        var e, f;
        function j(c) {
            A.start = x ? c.pageX : c.pageY;
            c = parseInt(q.obj.css(s));
            e = "auto" == c ? 0 : c;
        ...
        function o(a) {
            1 <= n.ratio || (f = Math.min(r[c.axis] - q[c.axis], Math.max(0, e + ((x ? a.pageX : a.pageY) - A.start))), v = f * p.ratio, n.obj.css(s, -v), q.obj.css(s, f));
            return !1
        }
        var h = {
            obj: a(".viewport", b)
        ...
        this.update = function(a) {
            h[c.axis] = h.obj[0]["offset" + y];
            n[c.axis] = n.obj[0]["scroll" + y];
        ...
        this.isAtLastScrollLine = function() {
            return 1 <= n.ratio || v == n.obj[0]["scroll" + y] - h.obj[0]["offset" + y]
        };
        this.update();
        (function() {
        ...
        n = c.BufferedBlockAlgorithm = f.extend({
            ...
            _process: function(c) {
                var b = this._data,
                    ...
                    e = a.min(4 * c, e);
                if (c) {
                    for (var m = 0; m < c; m += f) this._doProcessBlock(d, m);
                    m = d.splice(0, c);
                    b.sigBytes -= e
                }
    ...
    var r = [],
        d = d.SHA256 = e.extend({
            ...
            _doProcessBlock: function(a, c) {
                for (var b = this._hash.words, d = b[0], e = b[1], f = b[2], h = b[3], m = b[4], k = b[5], o = b[6], n = b[7], p = 0; 64 > p; p++) {
                    if (16 > p) r[p] = a[c + p] | 0;
                    else {
                        var N = r[p - 15],
                            J = r[p - 2];
...
(function(a) {
    ...
    b.prototype = {
        ...
        getTitle: function() {
            ...
            this.fixTitle();
            b = this.options;
            "string" == typeof b.title ? a = c.attr("title" == b.title ? "original-title" : b.title) : "function" == typeof b.title && (a = b.title.call(c[0]));
            return (a = ("" + a).replace(/(^\s*|\s*$)/, "")) || b.fallback
        },
        tip: function() {
...
var SERVER_TYPE = GetServerType(),
    debug = !1;
"127.0.0.1" == location.hostname && console && (debug = !0);
...
var BULLETS = Object.freeze({
    ...
    g_audio_is_music_on = OPTIONS.music,
    g_audio_is_effects_on = OPTIONS.effects;
...
$.prototype.draggable2 = function() {
    ...
    $(document).mousemove(function(k) {
        ...
        d && a.css({
            left: (f + (k.pageX - c)) / g_aspect_ratio - g_no_aspect_left + "px",
            top: (j + (k.pageY - e)) / g_aspect_ratio - g_no_aspect_top + "px"
        })
    });
...
function GameShare(a, b, d, c, e) {
    ...
    for (var q = 0; q < k.length; q++) {
        var x = k[q],
            s = x[2],
            y = x[1];
        x[0] % 2 == j ? (m++, d.push(s), c == y ? p = "win" : o.push(s)) : (h.push(s), c == y ? p = "lose" : o.push(s));
        r++
    }
    var v;
...
function FixPrototype(a) {
    ...
    setInterval(function() {
        ...
        d && (window.onbeforeunload = void 0, $.post("/b", {
            u: a.user_id,
            r: 1
        }, function() {
...
function ChatReceived(a, b, d, c, e, f) {
    ...
    return;
    j && (c = '<div class="zotata-chat-line zotata-chat-type' + d + '" >' + (1 <= d && 4 != d && 9 >= d ? '<div class="zotata-chat-icon zotata-chat-icon' + d + '"></div> ' : " ") + ("" != b ? BuildPlayerNameWithGuild(c, b) + "] " : "") + a + "</div>", f = $(j), j = f.tinyscrollbar_isAtLastScrollLine(), $(k).append(c), f.tinyscrollbar_update(j ? "bottom" : "relative"))
}
...
function GetServerType() {
    ...
    return "127.0.0.1" == a ? "dev" : "dragonbound-brasil.com" == a || "br.dragonbound.net" == a || "dragonbound.com.br" == a || "dragonbound.net.br" == a ? "br" : "gl"
}
...
function CShot(a, b, d, c, e, f) {
    ...
    j.prototype.GetPosAtTimeOrbit = function(a, c, b, d, e) {
        var a = a / 1E3,
            f = this.y0 + this.v.y * a + this.ay * a * a / 2;
        return {
            x: Math.round(this.x0 + this.v.x * a + this.ax * a * a / 2 + (a >= d ? e : e * a / d) * Math.cos(AngleToRad(c + b * a))),
            y: Math.round(f - (a >= d ? e : e * a / d) * Math.sin(AngleToRad(c + b * a)))
        }
    };
...
function DragonBound(a, b, d) {
    ...
    this.dn = d;
    this.camera = new CCamera(p, function(a, c) {
        x.OnCameraUpdate(a, c)
    });
...
DragonLogin.prototype.ShowConnectToFacebookButton = function() {
    var a = this;
    DragonDialogOpen(l.t("Welcome to DragonBound"), l.t("Who are you?") + '<div id="ConnectWithFacebook" class="glow_button_anim"></div><div id="ConnectWithPassword" class="glow_button_anim"></div><div id="NewUser1"><div id="NewUser1Text" class="blackShadow">' + l.t("New User?<br>(1) Click Here") + "</div></div>", DIALOG_BUTTONS_NONE, void 0, [35, 52]);
...
function ServerTimer_PostToFacebook() {
    var a = "icon180x180.png icon2_180x180.png icon3_180x180.jpg icon4_180x180.jpg icon5_180x180.jpg icon6_180x180.jpg".split(" "),
        ...
        c = "br" == SERVER_TYPE ? "http://dragonbound-brasil.com" : "http://127.0.0.1",
...
var AUDIO_ARMOR_MOVE = 0,
    ...
    AUDIO_DINO_FIRE = 41,
    AUDIO_DINO_BLAST = 42,
    g_sound_files = "1move 11blast 11fire 11move 1move 12blast 12fire 111blast 111fire 112blast 161fire 162fire bpush1 dbtheme dbwaiting dbparty turn turnwa bselect1 gold 51fire 52fire 51blast 52blast 82fire 82blast 91fire 91blast 92blast 10s1fire 15s1fire 10s1blast wind3 wait start login broker 31fire 32fire 31blast 32blast 42fire 42blast".split(" "),
...
function CAnimatedObject(a, b, d, c, e, f, j, k, m, o, h, n, p, r, q, x, s) {
    this.frames = h;
...
DragonNetwork.prototype.ConnectToGameServer = function(a, b) {
    ...
    e[SERVER_OPCODE.hi] = function(a, b, e, m) {
        ...
        if (a != VERSION && a != VERSION2) g_dont_show_disconnect_window = !0, d.Disconnect(), DragonDialogOpen(l.t("Update Available"), l.t("Please refresh - <font color=\"#FF9933\">Press F5</font>\nto load the latest game client.\n\nIf it doesn't help try Shift+F5 or clear your browser's cache."));
            ...
            if (e !== g_server_type || e !== m) g_server_type = e, g_server_subtype = m, SetLobby(c, e, m);
    ...
    e[SERVER_OPCODE.my_player_info] = function(a) {
        ...
        var b = {
            ...
            plus10gp: a[MYINFO_PACKET.plus10gp],
            mobile_fox: a[MYINFO_PACKET.mobile_fox]
        };
        1 == g_server_type && a[MYINFO_PACKET.tournament] && SetTournamentInfo(a[MYINFO_PACKET.tournament]);
        a = c.myPlayerInfo;
        c.myPlayerInfo = b;
        ...
        if (c.myPlayerInfo.location_type == LOCATION_TYPE_CHANNEL) {
            if (c.location != GUI_LOCATION_SHOP ? (c.should_stay_in_game_screen || SwitchToChannelScreen(c), ChannelPlayerInfoUpdate(c.myPlayerInfo, 1 == g_server_type ? c.lobbyMobile : void 0), ShopSetMyGoldCash(c.myPlayerInfo.gold, c.myPlayerInfo.cash)) : a.location_type == LOCATION_TYPE_ROOM && alertify.success("You were moved to lobby"), QUICK_JOIN && QUICK_JOIN.room) debug && console.log("Quick Join room:", QUICK_JOIN), c.SendRoomJoin(QUICK_JOIN.room, QUICK_JOIN.password), QUICK_JOIN = void 0
        } else c.myPlayerInfo.location_type == LOCATION_TYPE_ROOM && (!a || a && a.location_type != LOCATION_TYPE_ROOM) && SwitchToRoomScreen(c);
        QUICK_JOIN = void 0
    };
    ...
    e[SERVER_OPCODE.room_state] = function(a) {
        if (c.myPlayerInfo.location_type == LOCATION_TYPE_CHANNEL) {
            ...
            SetValue("in_room", 0)
        } else c.myPlayerInfo.room_number = a[E_ROOM_STATE_INDEX.number], RoomUpdate(c, a), history && history.replaceState && (b = a[E_ROOM_STATE_INDEX.password] ? "/password-" + encodeURIComponent(a[E_ROOM_STATE_INDEX.password]) : "", history.replaceState("", "", "#server-" + (c.server + 1) + "/room-" + c.myPlayerInfo.room_number + b)), c.my_room_pw = a[E_ROOM_STATE_INDEX.password], SetValue("in_room", 1)
    };
...
DragonNetwork.prototype.BrokerConnect = function() {
    ...
    var a = this,
        b, d;
    "gl" == SERVER_TYPE ? (b = "127.0.0.1", d = 80) : "br" == SERVER_TYPE ? (b = "game2.dragonbound.net", d = 9100) : (b = "127.0.0.1", d = 80);
...
CPlayer.prototype.CreateDivs = function() {
    ...
    this.divPlayer = $("<div/>", {
        ...
        style: "position:absolute;left:-10px;top:17px;width:120px;font-family:arial;font-size:12px;" + ("A" == this.team ? "color: #FF9f6B;" : "color: #BDCFCF;"),
        "class": "blackShadow"
...
function RoomPlayerUpdateGUI(a) {
    ...
    for (var j = 0; j < f; j++) {
        ...
        if (b) {
            ...
            m.children(".roomPlayerRank").removeClass().addClass("roomPlayerRank rank rank" + b.rank);
            m.children(".roomPlayerName").html(BuildPlayerNameWithGuild(b.guild, b.game_id));
            ...
            m.show()
        } else m.children(".roomPlayerBalloon, .roomPlayerBalloonTip").removeClass("text_anim"), m.children(".roomPlayerName").html(""), m.hide(), o && (o.remove(), g_room_slot_graphic2[j] =
        void 0)
    }
    $("#add_bot_button").hide();
    ...
    for (j = 0; j < f; j++) b = g_room_players_slots[j], k = "#playerInRoom" + j, m = $(k), k = 0 == j % 2 ? c : e, o = (!d || "." == d ? 257 - 48 * (Math.floor(k) - 1) : 113) + 97 * Math.floor(j / 2), m.css("top", o), m = $("#vortex" + j), m.css("top", o - 50), b ? m.hide() : (Math.floor(j / 2) < k && (0 == j % 2 || 1 != g_server_type) ? m.show() : m.hide(), g_game_mode == GAME_MODE_BOSS && (j == 2 * e - 1 && 0 < a.unlock) && ($("#add_bot_button").css("top", o + 40).show(), g_add_bot_to_slot = j))
}
...
function DragonRankings_BuildPage(a, b, d, c) {
    var e = a.length,
        ...
        x;
    o = $("#infoName");
    for (o.is(":visible") && (x = o.html()); m < e;) {
        o = a[m++];
        h = a[m++];
        n = a[m++];
        p = "string" == typeof a[m] ? a[m++] : "";
        k += "<tr";
        if (n == q || n == c) k += ' class="ranking_me"';
        r && (r = !0, p = n, n = "");
        k += "><td>" + j + '</td><td><div class="rank rank' + h + '"></div></td><td><div class="ranking_name"><span class="GuildName"><a href="/guild?name=' + encodeURIComponent(p) + '" target="_blank">' + p + "</a></span> " + n + "</div></td><td>" + o + "</td></tr>";
        n == x && $("#infoRanking").html(j);
        j++
    }
    k += "</table>";
    a = 3 == b ? '<div class="Nav"><button id="btnRPrev">&lt;-</button> ' + l.t("Friends") + ' <button id="btnRNext">-&gt;</button></div>' : '<div class="Nav"><button id="btnRPrev">&lt;-</button><button id="btnMe">' + l.t("ME") + "</button>" + l.t("Search") + ': <input id="rankingOffset" value="' + f + '"><button id="btnRNext">-&gt;</button></div>';
    $("#ranking_data").html(a + k);
    $("#btnRPrev").click(function() {
        3 == b ? ShowFriendsRanking(d, Math.max(1, f - RANKING_PAGE_SIZE)) : LoadRanking(b, Math.max(1, f - RANKING_PAGE_SIZE), d)
    });
    $("#btnRNext").click(function() {
        3 == b ? ShowFriendsRanking(d, Math.max(1, f + RANKING_PAGE_SIZE)) : LoadRanking(b, Math.max(1, j), d)
    });
    3 != b && ($("#btnMe").click(function() {
        d.myPlayerInfo ? r && !d.myPlayerInfo.guild ? alertify.log("You don't have a guild. Join one.") : LoadRanking(b, r ? d.myPlayerInfo.guild : d.myPlayerInfo.game_id, d) : alertify.log("Don't know who you are, enter a server.")
...
function ShowContact() {
    ...
    b = "br" == SERVER_TYPE ? [
        ...
        ["Renzo ^^!", "GameMasterRenzo", "Spanish, English"],
        ...
        ["Pinuna", "pages/GM-Pinuna/172908236234224", "Filipino, English"]
    ];
...
function ShopGUI(a) {
    ...
    $("#buttonShopBuy").click(function() {
        AudioPlay(AUDIO_BUTTON_SELECT2);
        ShopBuy();
        2 > a.user_rank ? $("#buttonChargeShop").hide() : $("#buttonChargeShop").show()
    });
    ...
    for (c = 0; c < a.length; c++) {
        ...
        if (void 0 == j) debug && console.log("*** ERROR: Unknown avatar:", e);
            ...
            var e = j[AVATAR_INDEX_TYPE],
                x = j[AVATAR_INDEX_GENDER],
                s = j[AVATAR_INDEX_NAME],
                y = void 0;
            if (p) if (p = new Date(p) - new Date, p >= MS_IN_1_DAY) y = Math.floor(p / MS_IN_1_DAY) + 1 + " Days";
            else if (0 < p) y = Math.floor(p / MS_IN_1_HOUR) + 1 + " Hours";
            else
            continue;
            k += '<div id="shop_my_item' + c + '" class="shop_my_item" onmousedown="ShopSelectMyItem(' + c + ",'" + b + '\')" avatar_id="' + n + '" avatar_number="' + f + '" avatar_type="' + e + '">';
            q ? k += '<div class="shop_my_item_gift"></div>' : r && (k += '<div class="shop_my_item_cash"></div>');
            k += '<div class="shop_my_item_icon shop_item_icon_' + e + x + '"></div><div class="shop_my_item_name">' + s + (y ? " (" + y + ")" : "") + '</div><div class="shop_my_item_equip' + (d ? " equipped" : "") + ' "></div>';
            for (r = n = 0; r < m.length; r++) q = o[r], p = m[r], j[q] && (k += '<div class="shop_my_item_stat shop_my_item_stat' + n + '"> <div class="stat_icon stat_icon_' + (0 < j[q] ? p : p + "-") + '"></div> <div class="stat_digit1 stat_font stat_font' + Math.floor(Math.abs(j[q] / 10)) + '"></div> <div class="stat_digit2 stat_font stat_font' + Math.abs(j[q] % 10) + '"></div> </div>', n++);
            k += "</div>";
            d && g_shop_player.change(f);
...
function ShopSetPage(a, b, d, c) {
    ...
    for (f = 0; f < e.length; f++) {
        ...
        k =
        d[AVATAR_INDEX_URL] ? d[AVATAR_INDEX_URL] : j == AVATAR_TYPE_BACKGROUND ? STATIC_DIR + "images/backgrounds/b20" + k + ".png" : j == AVATAR_TYPE_FOREGROUND ? STATIC_DIR + "images/backgrounds/f20" + k + ".png" : STATIC_DIR + "images/avatars/" + m + j + (k + 1E5).toString().substring(1) + ".png";
        ...
        $("#shop_item" + f + " .shop_item_cash").html(m ? Commatize(m) + " Cash" : "Gold Only");
...
function Facebook_PostToFeed(a) {
    var b = "icon180x180.png icon2_180x180.png icon3_180x180.jpg icon4_180x180.jpg icon5_180x180.jpg icon6_180x180.jpg".split(" "),
        ...
        e = "br" == SERVER_TYPE ? "http://dragonbound-brasil.com" : "http://127.0.0.1",
...
function OptionsDialogGUI(a) {
    ...
    $("#OptionGraphics input").change(function() {
        OptionsDialogOnChange(a)
    });
    $("#OptionsMusic").click(function() {
        $("#OptionsMusic").hasClass("CheckboxOn") ? (AudioTurnMusicOff(), SetValue("music", 0)) : (AudioTurnMusicOn(), SetValue("music", 1));
        AudioPlay(AUDIO_BUTTON_SELECT2);
        PrepareOptionsDialog( !! a.game)
    });
    $("#OptionsEffects").click(function() {
        $("#OptionsEffects").hasClass("CheckboxOn") ? (AudioTurnEffectsOff(), SetValue("effects", 0)) : (AudioTurnEffectsOn(), SetValue("effects", 1));
        AudioPlay(AUDIO_BUTTON_SELECT2);
        PrepareOptionsDialog( !! a.game)
    });
    ...
    $("#OptionsBackgroundOn").click(function() {
        ...
        PrepareOptionsDialog( !! a.game);
        a.game && a.game.ground && a.game.ground.SetMapBackground();
        SetValue("background", 1)
    });
...
function UpdateFriendsList(a, b, d, c) {
    ...
    d || (d = 100);
    var e = [],
        f = '<div class="refresh_button_friends" id="refresh_friends_button">&#8635; ' + l.t("Refresh List") + "</div>";
    a.sort(function(a, b) {
    ...
    for (var j = a.length, k = !1, m = 0; m < j; m++) {
        var o = a[m];
        if (m < d) {
            var h = o[FRIEND_INDEX_IMAGE],
                h = "" == h ? o[FRIEND_INDEX_GENDER] == GENDER_FEMALE ? STATIC_DIR + "images/fb_girl.gif" : STATIC_DIR + "/images/fb_boy.gif" : "http://graph.facebook.com/" + h + "/picture?type=large",
                n;
...
function ResellersGUI(a) {
    ...
    $("#resellers_btn").click(function() {
        SelectThisResellerButton(this);
        $("#chargeWindowPayment").html('<br> - PRECIOS OFICIALES DE CASH EN PERU - <br><br>18 Soles = 10,000 Cash + Fondo (Monedas de Oro cayendo)<br>34 Soles = 21,000 Cash + Fondo (Monedas de Oro cayendo)<br>66 Soles = 43,000 Cash + Fondo (Monedas de Oro cayendo)<br>97 Soles = 66,000 Cash + Fondo (Monedas de Oro cayendo)<br>200 Soles = 140,000 Cash + Fondo + Foreground (Monedas de Oro cayendo+ $)<br><br>* Muy pronto habr\u00e1 ofertas y promociones, porfavor siempre revisen los facebooks de los proveedores por novedades.<br><br><div id="reseller_accordion"><h3>Silkroad Per\u00fa</h3><div>Recargas de cash en solo 10 Minutos!<br><br>Los dep\u00f3sitos son SOLO por AGENTES BCP \u00f3 AGENTES INTERBANK.<br>Cta Agente BCP: 194-25114557-0-38<br>Cta Agente Interbank: 4893-0535-00887<br>Para mas informacion has clic en:<br>Facebook: <a href="https://www.facebook.com/GM.Ash10" target="_blank">facebook.com/GM.Ash10</a><br><br>Responsable: Victor Ra\u00fal Sarco Mamani<br>Movistar: 97855-0695<br>Fijo: 393-2733<br>Email: <a href="mailto:dragonbound2013@hotmail.com">dragonbound2013@hotmail.com</a><br>Atencion Lunes a Domingo 8:00am a 10:00pm<br><br>Clic en el video para que sepas como recargar:<br><a href="http://www.youtube.com/watch?v=W57FR_pxEp4" target="_blank">http://www.youtube.com/watch?v=W57FR_pxEp4</a><br></div><h3>MasterCadeM: PERU - BOLIVIA - ARGENTINA</h3><div>Las Recargas mas r\u00e1pidas para DragonBound las encuentras con nosotros.<br><br> - EN PERU -<br>Recuerda los dep\u00f3sitos son SOLO por AGENTES BCP \u00f3 AGENTES INTERBANK.<br>Cta agente BCP: 1931-9613-6600-76<br>Cta agente Interbank: 170-3051-8118-40<br>Para mas informacion has click en:<br>Facebook: <a href="https://www.facebook.com/Recarga.CASH.dragonbound" target="_blank">facebook.com/Recarga.CASH.dragonbound</a><br><br> - EN ARGENTINA - tus recargas en pesos argentinos<br>Para mas informacion has click en:<br>Facebook: <a href="https://www.facebook.com/Dragonbound.Cash.Mastercadem.Argentina" target="_blank">facebook.com/Dragonbound.Cash.Mastercadem.Argentina</a><br><br> - EN BOLIVIA  - tus recargas en bolivianos<br>Para mas informacion has click en:<br>Facebook: <a href="https://www.facebook.com/Dragonbound.Bolivia.Mastercadem" target="_blank">facebook.com/Dragonbound.Bolivia.Mastercadem</a><br><br>Responsable general: Charles Ortiz Brice\u00f1o<br>RPM (movistar): #975544437<br>RPC (claro): 986558320<br>Fijo: 01-2912030<br>Email: <a href="mailto:mastercadem@gmail.com">mastercadem@gmail.com</a><br></div><h3>FlechaGLS - dragonbound.org</h3><div>Recargas de Cash 100% seguras para DragonBound en Per\u00fa. Ventas especiales tambi\u00e9n para Administradores de Cabinas de Internet (CiberCaf\u00e9s)<br><br>Dep\u00f3sitos SOLO por AGENTES BCP \u00f3 AGENTES INTERBANK.<br>N\u00b0 de cta. InterBank: 286-3051422301<br>N\u00b0 de cta. Banco de Cr\u00e9dito BCP: 191-25173925-0-06<br><br>Website: <a href="http://www.dragonbound.org" target="_blank">dragonbound.org</a><br>Facebook: <a href="https://www.facebook.com/DragonboundCash" target="_blank">facebook.com/DragonboundCash</a><br><br>Responsable: Dyanfield Andres Villanueva L\u00f3pez<br>Cel: 943972729<br>Email: <a href="mailto:dragonbound.org@gmail.com">dragonbound.org@gmail.com</a><br></div><h3>GM Kommander</h3><div>SERVICIO DE RECARGAS DE CASH: SENCILLO, R\u00c1PIDO Y SEGURO.<br>Los dep\u00f3sitos son s\u00f3lo por AGENTES BCP \u00f3 AGENTES INTERBANK.<br><br>Para mas informacion has click en:<br>Facebook: <a href="https://www.facebook.com/pages/GM-Kommander/473619026023417" target="_blank">facebook.com/pages/GM-Kommander/473619026023417</a><br>Cta agente BCP: 1922-5380-6440-13<br>Cta agente Interbank: 122-5380-6440-13<br><br>Responsable: David Sebastian Rodr\u00edguez Herrera<br>Claro: 991851540<br>Movistar: 945115556<br>Email: <a href="mailto:gmkommander@gmail.com">gmkommander@gmail.com</a></div><h3>GM Zamy + GM Carlos* + GM tkspr0</h3><div>Recargas de 10-15 minutos<br><br>Recarga Cash Dentro & Fuera De Peru / Venta De Pins<br>(Especial Para Cabinas De Internet Ah Precio Comodo)<br><br>Escoge El Mejor Precio Para Ti En Nuestra Tienda Virtual -><br><a href="https://www.facebook.com/GMZamy/app_354565461292276" target="_blank">https://www.facebook.com/GMZamy/app_354565461292276</a><br><br>Cuentas De Deposito<br>Cta agente BCP: 191-26611575-0-77<br>Cta agente Interbank: 159-3053310-4-02<br><br>Responsable: Carlos Mere Manchego<br>Email: <a href="mailto:recargasdb@hotmail.com">recargasdb@hotmail.com</a><br>Web: <a href="http://www.recargasdb.com" target="_blank">www.recargasdb.com</a><br><br>Movistar: 974 900 222<br><br>No Sabes Como Recargar Mira Este Video<br><a href="https://www.facebook.com/photo.php?v=10151881813821180" target="_blank">https://www.facebook.com/photo.php?v=10151881813821180</a><br><br>Hora De Atencion 24/7</div><h3>Problemas con el cash? (Cash Problems?)</h3><div>Esperen 5 d\u00edas para que el distribuidor pueda procesar sus pagos. No es un proceso autom\u00e1tico.<br>Despu\u00e9s de eso puedes mandar tu prueba de pago y detalles a GM al correo <a href="http://dragonbound-forums.com/forumdisplay.php?fid=22" target="_blank">http://dragonbound-forums.com/forumdisplay.php?fid=22</a> y ser\u00e1 revisado.<br><br>Wait 5 days so the distributor can process your payment. It is not an automatic process.<br>After that time you can send your payment proof and details to GM at <a href="http://dragonbound-forums.com/forumdisplay.php?fid=22" target="_blank">http://dragonbound-forums.com/forumdisplay.php?fid=22</a> and it will be checked.</div></div><br><a href="/my_payments" target="_black">Mi historia de recargas + Mi numero ID (My Payments History + My User ID Number)</a><br>');
        ...
        return y = {
            ...
            addListeners: function(a) {
                var d, e, h, m, o, n = j !== b,
                    ...
                    v = this;
                d = function(c) {
                    return c.preventDefault !== b && c.preventDefault(), h(c), q !== b && (x = q.value), "function" == typeof a && (q !== b ? a(!0, x) : a(!0)), !1
                };
                e = function(c) {
            ...
            build: function(a) {
                var b = "",
                    ...
                    d = a.message,
                    a = a.cssClass || "";
                switch (b += '<div class="alertify-dialog">', "none" === s.buttonFocus && (b += '<a href="#" id="alertify-noneFocus" class="alertify-hidden"></a>'), "prompt" === c && (b += '<form id="alertify-form">'), b += '<article class="alertify-inner">', b += y.message.replace("{{message}}", d), "prompt" === c && (b += y.input), b += y.buttons.holder, b += "</article>", "prompt" === c && (b += "</form>"), b += '<a id="alertify-resetFocus" class="alertify-resetFocus" href="#">Reset Focus</a>', b += "</div>", c) {
                case "confirm":
                    b = b.replace("{{buttons}}", this.appendButtons(y.buttons.cancel, y.buttons.ok));
                    b = b.replace("{{ok}}", this.labels.ok).replace("{{cancel}}", this.labels.cancel);
                    break;
                case "prompt":
                    b = b.replace("{{buttons}}", this.appendButtons(y.buttons.cancel, y.buttons.submit));
                    b = b.replace("{{ok}}", this.labels.ok).replace("{{cancel}}", this.labels.cancel);
                    break;
                case "alert":
                    b = b.replace("{{buttons}}", y.buttons.ok), b = b.replace("{{ok}}", this.labels.ok)
                }
...
(function() {
    ...
    var k = "undefined" != typeof io ? io : module.parent.exports,
        ...
        x = p.advice = ["reconnect"],
        s = k.JSON,
        y = k.util.indexOf;p.encodePacket = function(a) {
        var b = y(r, a.type),
            c = a.id || "",
            d = a.endpoint || "",
            e = a.ack,
        ...
        switch (a.type) {
        case "error":
            var h = a.reason ? y(q, a.reason) : "",
                a = a.advice ? y(x, a.advice) : "";
            if ("" !== h || "" !== a) f = h + ("" !== a ? "+" + a : "");
            break;
        case "message":
            "" !== a.data && (f = a.data);
    ...
    if ("undefined" != typeof window) {
        var Y, fa = function() {
            ...
            k = function(a) {
                ...
                else if (typeof w.addEventListener != D) w.addEventListener("load", a, !1);
            ...
            Ea = function(a, b, c, d) {
                ...
                if (e) {
                    ...
                    d = "MMredirectURL=" + R.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + d + "&MMdoctitle=" + w.title;
                    typeof b.flashvars != D ? b.flashvars += "&" + d : b.flashvars = d;
                    u.ie && (u.win && 4 != e.readyState) && (d = w.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), e.parentNode.insertBefore(d, e), e.style.display = "none", function() {
            ...
            va = function(a, b, c) {
                ...
                if (e) if (typeof a.id == D && (a.id = c), u.ie && u.win) {
                    ...
                    for (f in b) b[f] != Object.prototype[f] && "movie" != f.toLowerCase() && (a = j, h = f, m = b[f], c = w.createElement("param"), c.setAttribute("name", h), c.setAttribute("value", m), a.appendChild(c));
            ...
            Fa = function(a, b, c, d) {
                if (!u.ie || !u.mac) {
                    ...
                    if (e) {
                        ...
                        d && (ba = null, Ha = null);
                        if (!ba || Ha != c) d = w.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), ba = e.appendChild(d), u.ie && u.win && typeof w.styleSheets != D && 0 < w.styleSheets.length && (ba = w.styleSheets[w.styleSheets.length - 1]), Ha = c;
                        u.ie && u.win ? ba && typeof ba.addRule == V && ba.addRule(a, b) : ba && typeof w.createTextNode != D && ba.appendChild(w.createTextNode(a + " {" + b + "}"))
                    }
                }
            },
            Z = function(a, b) {
        ...
        var Ga = !1,
            ...
            Ba = !1,
            ba, Ha, Ca = !0,
            u, o = typeof w.getElementById != D && typeof w.getElementsByTagName != D && typeof w.createElement != D,
        ...
        if (typeof m.plugins != D && typeof m.plugins["Shockwave Flash"] == V)(H = m.plugins["Shockwave Flash"].description) && (typeof m.mimeTypes == D || !m.mimeTypes[za] || m.mimeTypes[za].enabledPlugin) && (Ga = !0, ya = !1, H = H.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), la[0] = parseInt(H.replace(/^(.*)\..*$/, "$1"), 10), la[1] = parseInt(H.replace(/^.*\.(.*)\s.*$/, "$1"), 10), la[2] = /[a-zA-Z]/.test(H) ? parseInt(H.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
            ...
            z && (H = z.GetVariable("$version"), H && (ya = !0, H = H.split(" ")[1].split(","), la = [parseInt(H[0], 10), parseInt(H[1], 10), parseInt(H[2], 10)]))
        } catch (Na) {}
        u = {
            w3: o,
            pv: la,
        ...
        u.w3 && ((typeof w.readyState != D && "complete" == w.readyState || typeof w.readyState == D && (w.getElementsByTagName("body")[0] || w.body)) && fa(), ja || (typeof w.addEventListener != D && w.addEventListener("DOMContentLoaded", fa, !1), u.ie && u.win && (w.attachEvent("onreadystatechange", function() {
            "complete" == w.readyState && (w.detachEvent("onreadystatechange", arguments.callee), fa())
        }), R == top &&
        function() {
            if (!ja) {
                try {
        ...
        function() {
            ja || (/loaded|complete/.test(w.readyState) ? fa() : setTimeout(arguments.callee, 0))
        }(), k(fa)));
    ...
    ("undefined" != typeof io ? io.Transport : module.exports)["jsonp-polling"] = z;U.util.inherit(z, U.Transport["xhr-polling"]);z.prototype.name = "jsonp-polling";z.prototype.post = function(a) {
        function b() {
            c();
            d.socket.setBuffer(!1)
        }
