...
namespace GameServerDB.ChanelManager
{
    ...
    public class Channel
    {
        ...
        #region Public
        //-----------------------------------------------------------------------------------------------------
        public int chanel_id { set { _channel_id = value; } get { return _channel_id; } }
        public string chanel_name { set { _channel_name = value; } get { return _channel_name; } }
        public int chanel_useronli { set { _channel_useronli = value; } get { return _channel_useronli; } }
        public int chanel_maxplayers { set { _channel_maxplayers = value; } get { return _channel_maxplayers; } }
        public int chanel_status { set { _channel_status = value; } get { return _channel_status; } }
        public int chanel_gamemode { set { _channel_gamemode = value; } get { return _channel_gamemode; } }
        public int chanel_map { set { _channel_map = value; } get { return _channel_map; } }
        public int chanel_poweruse { set { _channel_poweruse = value; } get { return _channel_poweruse; } }
        public string chanel_password { set { _channel_password = value; } get { return _channel_password; } }
        //-----------------------------------------------------------------------------------------------------
        #endregion
        //-----------------------------------------------------------------------------------------------------
        ...
        public static void SendList()
        {
            ...
            using (JsonWriter writer = new JsonTextWriter(sw))
            {
                ...
                foreach (Channel _cha in Program.Chanels)
                {
                    ...
                    writer.WriteValue(_cha._channel_useronli);
